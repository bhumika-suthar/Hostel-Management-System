...
public class StudentFees extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 60, 40, -1));

        jLabel2.setText("        Student ID");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 110, 100, -1));

        jLabel3.setText("Allotment ID");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 170, 79, -1));
        ...
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 110, 368, -1));
        ...
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 170, 368, -1));
        getContentPane().add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 220, 368, -1));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here: 
        //int payment_id = Integer.valueOf(jTextField1.getText());
        String student_id = jTextField1.getText();
        int allotment_id = Integer.valueOf(jTextField3.getText());
        String date = jTextField4.getText();
        int amount = Integer.valueOf(jTextField6.getText());
        
        try{
            Connection con=ConnectionProvider.getCon();
            PreparedStatement ps=con.prepareStatement("insert into payments values(null,?,?,?,?)");
            ps.setString(1,student_id);
            ps.setInt(2,allotment_id);
            ps.setString(3,date);
            ps.setInt(4,amount);
            ps.executeUpdate();
